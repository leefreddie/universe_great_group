...
\begin{table}[h]
  ...
  \begin{tabular}{c|c|cc|ccccc}
    \hline
    \multirow{2}{*}{城市} & \multirow{2}{*}{人口数量} & \multicolumn{2}{c|}{环境指标} & \multicolumn{5}{c}{公共设施数量}   \\
    \cline{3-9}
                          &                          &AQI&城市面积& 社区 & 医院 & 养老院 & 公园 &大学\\
    \hline
...
\hline
\multirow{2}{*}{} & \multirow{2}{*}{人口数量} & \multicolumn{2}{c|}{环境指标} & \multicolumn{5}{c}{公共设施数量} \\
\cline{3-9}
& & AQI & 区域面积 & 社区 & 医院 & 养老院 & 公园 & 大学 \\
\hline
\endfirsthead
